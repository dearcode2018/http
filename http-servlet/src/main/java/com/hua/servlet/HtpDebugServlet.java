 ...
 * 
 */
// 使用注解的方式 ( http://127.0.0.1:8080/servlet3/HtpDebugServlet )
@WebServlet(name="HtpDebugServlet", urlPatterns={"/HtpDebugServlet"})
public final class HtpDebugServlet extends BaseServlet
{
	 /* long */
