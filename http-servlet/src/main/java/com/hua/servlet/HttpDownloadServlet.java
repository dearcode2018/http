 ...
 * 
 */
// 使用注解的方式 ( http://127.0.0.1:8080/servlet3/HttpDownloadServlet )
@WebServlet(name="HttpDownloadServlet", urlPatterns={"/HttpDownloadServlet"})
public final class HttpDownloadServlet extends BaseServlet
{
	 /* long */
