 ...
 * 
 */
// 使用注解的方式 ( http://127.0.0.1:8080/servlet3/HttpUploadServlet )
@WebServlet(name="HttpUploadServlet", urlPatterns={"/HttpUploadServlet"})
public final class HttpUploadServlet extends BaseServlet
{
	 /* long */
