 ...
 * JdkHttpTest
 */
public class JdkHttpTest extends BaseTest {
	...
	public void testGet() {
		try {
			// java.net.URL
			serverUrl = new URL(testUrl + "?param=jdk_lisi");
			httpUrlConn = (HttpURLConnection) serverUrl.openConnection();
			// 设置请求方法
			httpUrlConn.setRequestMethod(HttpConstant.REQUEST_METHOD_GET);
	...
	public void testPost() {
		try {
			...
			httpUrlConn = (HttpURLConnection) serverUrl.openConnection();
			// 设置请求方法
			httpUrlConn.setRequestMethod(HttpConstant.REQUEST_METHOD_POST);
